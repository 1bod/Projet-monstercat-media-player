...
def openResearch():
    ...
    labelNombreRemplacement=Label(cadreRecherche, text="Numéro de titre à remplacer : ")
    ...
    cadreResultats = Frame(fenetreRecherche)
    cadreResultats.pack(side=TOP, padx=5, pady=5)
